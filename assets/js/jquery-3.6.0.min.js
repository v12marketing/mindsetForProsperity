          ...
          ? t.parentNode && !1 === t.disabled
            ? "label" in t
              ? "label" in t.parentNode
                ...
                : t.disabled === e
              : t.isDisabled === e || (!e !== t.isDisabled && ae(t) === e)
            : t.disabled === e
      ...
      function (e) {
        ...
        return (
          a != d &&
            ...
            (x =
              (t = K.test(h.compareDocumentPosition)) || K.test(h.contains)
                ? function (e, t) {
        ...
        if ("object" === x(o)) w.merge(f, o.nodeType ? [o] : o);
          ...
          for (
            a = a || c.appendChild(t.createElement("div")),
              s = ge[(de.exec(o) || ["", ""])[1].toLowerCase()] || ge._default,
            ...
            a = a.lastChild;
          w.merge(f, a.childNodes), ((a = c.firstChild).textContent = "");
        } else f.push(t.createTextNode(o));
    for (c.textContent = "", p = 0; (o = f[p++]); )
      if (r && -1 < w.inArray(o, r)) i && i.push(o);
      else if (
        ((u = ie(o)), (a = ve(c.appendChild(o), "script")), u && ye(a), n)
      )
        ...
        var r,
          ...
          E = {
            ...
            setRequestHeader: function (e, t) {
              return (
                null == l &&
                  (b[(e = T[e.toLowerCase()] = T[e.toLowerCase()] || e)] = t),
                this
              );
            },
