!(function (e, t) {
          ...
          ? e.parentNode && !1 === e.disabled
            ? "label" in e
              ? "label" in e.parentNode
                ...
                : e.disabled === t
              : e.isDisabled === t || (!t !== e.isDisabled && ae(e) === t)
            : e.disabled === t
      ...
      function (e) {
        ...
        return (
          (e = e ? e.ownerDocument || e : v) != C &&
            ...
            (m =
              (t = ee.test(a.compareDocumentPosition)) || ee.test(a.contains)
                ? function (e, t) {
        ...
        if ("object" === h(o)) E.merge(f, o.nodeType ? [o] : o);
          ...
          for (
            a = a || c.appendChild(t.createElement("div")),
              s = de[(fe.exec(o) || ["", ""])[1].toLowerCase()] || de._default,
        ...
        for (
          n.handler && ((n = (o = n).handler), (i = o.selector)),
            ...
            (a = h.handle) ||
              (a = h.handle =
                function (e) {
                  return E.event.triggered !== e.type
    ...
    special: {
      ...
      click: {
        ...
        trigger: function (e) {
          return (
            (e = this || e),
            ce.test(e.type) && e.click && A(e, "input") && Ce(e, "click"),
            !0
          );
        },
        _default: function (e) {
        ...
        reliableTrDimensions: function () {
          ...
          return (
            null == Ie &&
              ...
              (Ie =
                parseInt((n = T.getComputedStyle(t)).height, 10) +
  ...
  function ht(i, e, t) {
    ...
    for (
      ...
      if ((n = ht.prefilters[r].call(l, i, c, l.opts)))
        return (
          x(n.stop) &&
    ...
    E.fn.extend({
      ...
      toggleClass: function (i, t) {
        ...
        return "boolean" == typeof t && a
          ...
          ? this.each(function (e) {
              E(this).toggleClass(i.call(this, e, bt(this), t), t);
            })
          : this.each(function () {
              var e, t, n, r;
              if (a)
                for (t = 0, n = E(this), r = wt(i); (e = r[t++]); )
                  n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
              else
                (void 0 !== i && "boolean" != o) ||
                  ((e = bt(this)) && Y.set(this, "__className__", e),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
      ...
      hasClass: function (e) {
        for (var t, n = 0, r = " " + e + " "; (t = this[n++]); )
          if (1 === t.nodeType && -1 < (" " + xt(bt(t)) + " ").indexOf(r))
            return !0;
        return !1;
      },
    });
  ...
  E.extend(E.event, {
    trigger: function (e, t, n, r) {
      ...
      if (
        ...
        if (!r && !l.noBubble && !g(n)) {
          for (
            a = l.delegateType || p, Et.test(a + p) || (h = h.parentNode);
            h;
            h = h.parentNode
          )
            f.push(h), (o = h);
        ...
        var u,
          ...
          b = {
            ...
            setRequestHeader: function (e, t) {
              return (
                null == p &&
                  (o[(e = a[e.toLowerCase()] = a[e.toLowerCase()] || e)] = t),
                this
              );
            },
        ...
        h.hasContent
          ...
          : ((e = h.url.slice(l.length)),
            h.data &&
              ...
              ((l += (At.test(l) ? "&" : "?") + h.data), delete h.data),
            !1 === h.cache &&
              ((l = l.replace(Ot, "$1")),
              (e = (At.test(l) ? "&" : "?") + "_=" + kt.guid++ + e)),
            (h.url = l + e)),
        h.ifModified &&
          (E.lastModified[l] &&
  ...
  return (
    (E.noConflict = function (e) {
      return T.$ === E && (T.$ = Jt), e && T.jQuery === E && (T.jQuery = Qt), E;
    }),
